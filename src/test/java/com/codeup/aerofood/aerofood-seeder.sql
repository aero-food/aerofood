...
insert into order_status(status) values('In-route');
...
insert into cuisine (description) values ('Mexican');

insert into cuisine (description) values ('Breakfast');

insert into cuisine (description) values ('Lunch');
insert into cuisine (description) values ('Dinner');

insert into cuisine (description) values ('Comfort');

insert into cuisine (description) values ('German');
...
insert into menu_category (description) values ('Soup');
